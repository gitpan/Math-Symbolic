...
sub Parse::RecDescent::Math::Symbolic::Parser::Precompiled::parse
{
	...
	while (!$_matched && !$commit)
	{
		...
		Parse::RecDescent::_trace(q{Trying production: [<reject:<reject:1>>]},
					  Parse::RecDescent::_tracefirst($_[1]),
					  q{parse},
					  $tracelevel)
						if defined $::RD_TRACE;
		...
		Parse::RecDescent::_trace(q{Trying directive: [<reject:<reject:1>>]},
					Parse::RecDescent::_tracefirst($text),
					  q{parse},
					  $tracelevel)
						if defined $::RD_TRACE; 
		...
		Parse::RecDescent::_trace(q{>>Matched production: [<reject:<reject:1>>]<<},
					  Parse::RecDescent::_tracefirst($text),
					  q{parse},
					  $tracelevel)
						if defined $::RD_TRACE;
