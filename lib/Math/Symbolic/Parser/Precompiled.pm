...
q{>>Matched operator: [<leftop: expr list_op expr>]<< (return value: [}
    ...
    sub Parse::RecDescent::Math::Symbolic::Parser::Precompiled::exp {
        ...
        while ( !$_matched && !$commit ) {
            ...
            Parse::RecDescent::_trace(
                q{Trying production: [<leftop: factor exp_op factor>]},
                Parse::RecDescent::_tracefirst( $_[1] ),
                q{exp}, $tracelevel
              )
              if defined $::RD_TRACE;
            ...
            Parse::RecDescent::_trace(
                q{Trying operator: [<leftop: factor exp_op factor>]},
                Parse::RecDescent::_tracefirst($text),
                q{exp}, $tracelevel
              )
              if defined $::RD_TRACE;
          ...
          OPLOOP: while (1) {
            ...
            unless ( $repcount >= 1 ) {
                Parse::RecDescent::_trace(
q{<<Didn't match operator: [<leftop: factor exp_op factor>]>>},
                    Parse::RecDescent::_tracefirst($text),
                    q{exp},
                    $tracelevel
                  )
            ...
            Parse::RecDescent::_trace(
q{>>Matched operator: [<leftop: factor exp_op factor>]<< (return value: [}
                  . qq{@{$_tok||[]}} . q{]},
                Parse::RecDescent::_tracefirst($text),
                q{exp},
                $tracelevel
            ...
            $_tok = ($_noactions) ? 0 : do {
                ...
                Math::Symbolic::Parser::_leftop_list( 'exp', @item );
            };
            unless ( defined $_tok ) {
                Parse::RecDescent::_trace(
                    q{<<Didn't match action>> (return value: [undef])})
            ...
            Parse::RecDescent::_trace(
                q{>>Matched production: [<leftop: factor exp_op factor>]<<},
                Parse::RecDescent::_tracefirst($text),
                q{exp}, $tracelevel
              )
              if defined $::RD_TRACE;
...
q{>>Matched operator: [<leftop: exp mult_op exp>]<< (return value: [}
            ...
            $_tok = ($_noactions) ? 0 : do {
                warn 'multiplication '
                  if $Math::Symbolic::Parser::DEBUG;
                Math::Symbolic::Parser::_leftop_list( 'multiplication', @item );
            };
            unless ( defined $_tok ) {
                Parse::RecDescent::_trace(
                    q{<<Didn't match action>> (return value: [undef])})
...
q{>>Matched operator: [<leftop: multiplication add_op multiplication>]<< (return value: [}
            ...
            $_tok = ($_noactions) ? 0 : do {
                warn 'addition '
                  if $Math::Symbolic::Parser::DEBUG;
                Math::Symbolic::Parser::_leftop_list( 'addition', @item );
            };
            unless ( defined $_tok ) {
                Parse::RecDescent::_trace(
                    q{<<Didn't match action>> (return value: [undef])})
